...
TEXT_TEST_FILE = 'morphingdb_text_16_batch_test.json'
TEXT_VECTOR_TEST_FILE = 'result/morphingdb_test.json'
MUTI_MODEL_TEST_FILE = 'result/morphingdb_test.json'
timing_data_image = []
timing_data_vector = []
